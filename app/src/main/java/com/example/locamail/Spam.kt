...
class Spam : ComponentActivity() {
    @OptIn(ExperimentalMaterial3Api::class)
    @Composable
    fun spamContent(scope: CoroutineScope, drawerState: DrawerState) {
    ...
    @Composable
    fun EmailItemSpam(email: EmailModel, onItemClick: () -> Unit) {
